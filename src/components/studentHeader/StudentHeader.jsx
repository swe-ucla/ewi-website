  ...
  return (
    <div className="student-header">
      <div className="student-header-content">
        ...
        <a className="button-link" href="https://docs.google.com/forms/d/1PfdlBL6_Ktjdf8y0rcf4T4torBHp0mVE85wQdN2TaOs/viewform?edit_requested=true" target="_blank" rel="noopener noreferrer">APPLY</a>
