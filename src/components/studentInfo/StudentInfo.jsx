  ...
  return (
    ...
    <div className="container student__content">
        ...
        <div className="student__paragraph">
          ...
          <br />
          <p> IMPORTANT: Evening with Industry will be on January 28th from 5:30-10:00 PM. If you cannot attend before 6:45 PM, please DO NOT register. Unfortunately, we are unable to save you seat. </p>
        </div>
